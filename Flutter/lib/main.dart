  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => CategoriesProvider(CategoriesRepository())),

        // Provide QuizService
        Provider<QuizService>(create: (_) => QuizService()),

        // Provide QuizProvider
        ChangeNotifierProxyProvider<QuizService, QuizProvider>(
          create: (ctx) => QuizProvider(ctx.read<QuizService>()),
