...
class AttemptDetailModel extends AttemptModel {
  ...
  factory AttemptDetailModel.fromJson(Map<String, dynamic> json) {
    final attemptData = (json['attempt'] as Map<String, dynamic>?) ?? json;
    ...
    return AttemptDetailModel(
      ...
      startedAt: AttemptModel.tryParseDate(attemptData['started_at']),
      expiresAt: AttemptModel.tryParseDate(attemptData['expires_at']),
      submittedAt: AttemptModel.tryParseDate(attemptData['submitted_at']),
      durationMinutes: (attemptData['duration_minutes'] as num?)?.toInt() ?? 0,
      remainingSeconds: (attemptData['remaining_seconds'] as num?)?.toInt() ?? 0,
