        ...
        <div style="display:flex;flex-direction:column;gap:0.75rem;height:100%;justify-content:space-between;">
            <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:0.75rem;">
                ...
                <select
                    ...
                    style="width:2rem;height:2rem;border:1px solid #d1d5db;border-radius:0.5rem;background:#ffffff;padding:0.2rem 0.35rem;font-size:0.75rem;font-weight:600;color:#6b7280;box-shadow:0 1px 2px rgba(0,0,0,0.05);outline:none;"
                >
