                    ...
                    @forelse ($this->getUsers() as $user)
                        ...
                        >
                            ...
                            <div style="flex:1;min-width:0">
                                ...
                                @endif
                                @if ($user->role === 'student' && $user->school_year)
                                    <div class="profile-editor-user-email" style="margin-top: 6px;">
                                        A.Y. {{ \App\Support\SchoolYears::format($user->school_year) }}
                                    </div>
                                @endif
                            </div>
                        </button>
                    ...
                    <div class="profile-editor-summary">
                        ...
                        <div class="profile-editor-meta-grid">
                            ...
                            @if ($selectedUser->role === 'student')
                                <div class="profile-editor-meta-cell">
                                    <div class="profile-editor-meta-key">School Year</div>
                                    <div class="profile-editor-meta-val">
                                        {{ $selectedUser->school_year ? \App\Support\SchoolYears::format($selectedUser->school_year) : 'N/A' }}
                                    </div>
                                </div>
                            @endif
                        </div>
