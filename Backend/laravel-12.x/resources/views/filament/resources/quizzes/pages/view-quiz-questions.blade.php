<x-filament-panels::page>
    ...
    <div class="questions-shell">
        <div class="questions-hero">
            <h1 class="questions-hero-title">{{ $this->getRecord()->title }}</h1>
            <p class="questions-hero-copy">
                Manage the questions inside this quiz. The same question interface is reused here, but scoped to the quiz instead of the whole subject.
            </p>
        </div>
                    ...
                    @forelse ($questions as $question)
                        <tr>
                            ...
                            <td class="questions-row-actions">
                                <a
                                    href="{{ \App\Filament\Resources\Questions\QuestionResource::getUrl('edit', ['record' => $question, 'quiz_id' => $this->getRecord()->id]) }}"
